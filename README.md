...
02. Clone the repository:
    ...
    ```console
    git clone --recursive https://github.com/danydodson/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    <details>
      ...
      - Clone the repository:
        ...
        ```console
        git clone --recursive https://github.com/danydodson/prezto.git "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
        ```
